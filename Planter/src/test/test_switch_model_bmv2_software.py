...
import time
import os
print('Predicted load table time ... (1.409s)')
time.sleep(1.409)
...
config_file = '/media/sf_Project/Project/Planter/src/temp/Test_Data.json'
...
for i in range(np.shape(test_X)[0]):
    iface = 'eth0'
    pkt = Ether(dst='00:04:00:00:00:00', type=0x1234) / Planter( feature0 = int(test_X[i][0]), feature1 = int(test_X[i][1]), feature2 = int(test_X[i][2]), feature3 = int(test_X[i][3]), feature4 = int(test_X[i][4]), result  = int(404))
    pkt = pkt/' '
