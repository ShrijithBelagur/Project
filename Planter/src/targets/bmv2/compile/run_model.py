...
def add_make_run_model(fname, config):
    ...
    test_command = 'h1 ' + python_bin + ' '+work_root+'/src/test/' + test_file_name +'.py'
    ...
    with open(fname, 'w') as command:
        ...
        # command.write("echo '" + test_command + "' | sudo -S make PYTHON_BIN=" + python_bin + " run\n")
        command.write("sudo make PYTHON_BIN=" + python_bin + " run\n")
