...
def main() -> None:
    ...
    parser.add_argument("--model", required=True, type=Path, help="Path to joblib/pickle sklearn DecisionTreeClassifier")
    parser.add_argument("--bindings", required=True, type=Path, help="JSON file mapping feature indices to P4 expressions")
    parser.add_argument("--out-json", default=Path("tree.json"), type=Path, help="Output JSON path")
    parser.add_argument("--out-p4", default=Path("generated_tree_new.p4"), type=Path, help="Output P4 path")
