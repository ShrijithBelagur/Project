...
current_dir = Path(__file__).parent
p4info_file_path = Path("../build/mlp_CICIOT.p4info.txt")
bmv2_json_path = Path("../build/mlp_CICIOT.json")
model_file_path = Path("../../make_dataset/mlp/CICIOT2022/mlp_CICIOT.pkl")
...
def load_tb_ternary_feat1_parameter3(table_data, table_name, feat_name, action_name):
    print("load_tb--{}.......".format(table_name))
    if len(table_data) > max_table_size:
        table_data = table_data[:max_table_size]; print("ERROR! ")
    for x in range(len(table_data)):
...
load_tb_ternary_feat1_parameter3(table3[0], "MyIngress.h2_1", "meta.linear3.l32_1", "MyIngress.set_h2_1")
load_tb_ternary_feat1_parameter3(table3[1], "MyIngress.h2_2", "meta.linear3.l32_2", "MyIngress.set_h2_2")
load_tb_ternary_feat1_parameter3(table3[2], "MyIngress.h2_3", "meta.linear3.l32_3", "MyIngress.set_h2_3")
load_tb_ternary_feat1_parameter3(table3[3], "MyIngress.h2_4", "meta.linear3.l32_4", "MyIngress.set_h2_4")
load_tb_ternary_feat1_parameter3(table3[4], "MyIngress.h2_5", "meta.linear3.l32_5", "MyIngress.set_h2_5")
load_tb_ternary_feat1_parameter3(table3[5], "MyIngress.h2_6", "meta.linear3.l32_6", "MyIngress.set_h2_6")
load_tb_ternary_feat1_parameter3(table3[6], "MyIngress.h2_7", "meta.linear3.l32_7", "MyIngress.set_h2_7")
load_tb_ternary_feat1_parameter3(table3[7], "MyIngress.h2_8", "meta.linear3.l32_8", "MyIngress.set_h2_8")
